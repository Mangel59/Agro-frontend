...
const columns = [
  ...
  { field: 'fechaVencimiento', headerName: 'Vence', width: 150, valueGetter: (params) => params.row.fechaVencimiento?.substring(0, 10) },
  { field: 'kardexId', headerName: 'Kardex ID', width: 120 },
  { field: 'productoPresentacionNombre', headerName: 'Presentación', width: 200 },
  {
    field: 'estadoId',
    headerName: 'Estado',
    width: 120,
