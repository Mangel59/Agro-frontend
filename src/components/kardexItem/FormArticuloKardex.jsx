      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        <form onSubmit={handleSubmit}>
          ...
          <DialogContent>
            ...
            <TextField fullWidth type="date" name="fechaVencimiento" label="Fecha Vencimiento"
              value={formData.fechaVencimiento?.substring(0, 10)} onChange={handleChange} margin="dense" InputLabelProps={{ shrink: true }} required />
